...
40000030:	8d 83 9c de ff ff    	lea    -0x2164(%ebx),%eax
...
40000069:	8d 83 a8 de ff ff    	lea    -0x2158(%ebx),%eax
...
400000a2:	8d 83 b4 de ff ff    	lea    -0x214c(%ebx),%eax
...
4000027b:	e8 e0 09 00 00       	call   40000c60 <__udivdi3>
...
400002ba:	e8 c1 0a 00 00       	call   40000d80 <__umoddi3>
400002bf:	83 c4 08             	add    $0x8,%esp
400002c2:	57                   	push   %edi
400002c3:	0f be 84 05 c0 de ff 	movsbl -0x2140(%ebp,%eax,1),%eax
400002ca:	ff 
...
400003e4:	03 8c 81 d8 de ff ff 	add    -0x2128(%ecx,%eax,4),%ecx
...
400004ef:	8d 80 d1 de ff ff    	lea    -0x212f(%eax),%eax
...
40000b7e:	8d 83 30 e0 ff ff    	lea    -0x1fd0(%ebx),%eax
...
40000b8a:	83 c4 08             	add    $0x8,%esp
40000b8d:	68 e8 03 00 00       	push   $0x3e8
40000b92:	6a 01                	push   $0x1
40000b94:	e8 30 fc ff ff       	call   400007c9 <spawn>
40000b99:	83 c4 10             	add    $0x10,%esp
40000b9c:	83 f8 40             	cmp    $0x40,%eax
40000b9f:	74 76                	je     40000c17 <main+0xb6>
        printf ("ping in process %d.\n", ping_pid);
40000ba1:	83 ec 08             	sub    $0x8,%esp
40000ba4:	50                   	push   %eax
40000ba5:	8d 83 36 e0 ff ff    	lea    -0x1fca(%ebx),%eax
40000bab:	50                   	push   %eax
40000bac:	e8 41 f6 ff ff       	call   400001f2 <printf>
40000bb1:	83 c4 10             	add    $0x10,%esp
    else
        printf ("Failed to launch ping.\n");

    if ((pong_pid = spawn (2, 1000)) != NUM_IDS)
40000bb4:	83 ec 08             	sub    $0x8,%esp
40000bb7:	68 e8 03 00 00       	push   $0x3e8
40000bbc:	6a 02                	push   $0x2
40000bbe:	e8 06 fc ff ff       	call   400007c9 <spawn>
40000bc3:	83 c4 10             	add    $0x10,%esp
40000bc6:	83 f8 40             	cmp    $0x40,%eax
40000bc9:	74 60                	je     40000c2b <main+0xca>
        printf ("pong in process %d.\n", pong_pid);
40000bcb:	83 ec 08             	sub    $0x8,%esp
40000bce:	50                   	push   %eax
40000bcf:	8d 83 63 e0 ff ff    	lea    -0x1f9d(%ebx),%eax
40000bd5:	50                   	push   %eax
40000bd6:	e8 17 f6 ff ff       	call   400001f2 <printf>
40000bdb:	83 c4 10             	add    $0x10,%esp
    else
        printf ("Failed to launch pong.\n");

    if ((ding_pid = spawn (3, 1000)) != NUM_IDS)
40000bde:	83 ec 08             	sub    $0x8,%esp
40000be1:	68 e8 03 00 00       	push   $0x3e8
40000be6:	6a 03                	push   $0x3
40000be8:	e8 dc fb ff ff       	call   400007c9 <spawn>
40000bed:	83 c4 10             	add    $0x10,%esp
40000bf0:	83 f8 40             	cmp    $0x40,%eax
40000bf3:	74 4a                	je     40000c3f <main+0xde>
        printf ("ding in process %d.\n", ding_pid);
40000bf5:	83 ec 08             	sub    $0x8,%esp
40000bf8:	50                   	push   %eax
40000bf9:	8d 83 90 e0 ff ff    	lea    -0x1f70(%ebx),%eax
40000bff:	50                   	push   %eax
40000c00:	e8 ed f5 ff ff       	call   400001f2 <printf>
40000c05:	83 c4 10             	add    $0x10,%esp
    else
        printf ("Failed to launch ding.\n");

    return 0;
}
40000c08:	b8 00 00 00 00       	mov    $0x0,%eax
40000c0d:	8d 65 f8             	lea    -0x8(%ebp),%esp
40000c10:	59                   	pop    %ecx
40000c11:	5b                   	pop    %ebx
40000c12:	5d                   	pop    %ebp
40000c13:	8d 61 fc             	lea    -0x4(%ecx),%esp
40000c16:	c3                   	ret    
        printf ("Failed to launch ping.\n");
40000c17:	83 ec 0c             	sub    $0xc,%esp
40000c1a:	8d 83 4b e0 ff ff    	lea    -0x1fb5(%ebx),%eax
40000c20:	50                   	push   %eax
40000c21:	e8 cc f5 ff ff       	call   400001f2 <printf>
40000c26:	83 c4 10             	add    $0x10,%esp
40000c29:	eb 89                	jmp    40000bb4 <main+0x53>
        printf ("Failed to launch pong.\n");
40000c2b:	83 ec 0c             	sub    $0xc,%esp
40000c2e:	8d 83 78 e0 ff ff    	lea    -0x1f88(%ebx),%eax
40000c34:	50                   	push   %eax
40000c35:	e8 b8 f5 ff ff       	call   400001f2 <printf>
40000c3a:	83 c4 10             	add    $0x10,%esp
40000c3d:	eb 9f                	jmp    40000bde <main+0x7d>
        printf ("Failed to launch ding.\n");
40000c3f:	83 ec 0c             	sub    $0xc,%esp
40000c42:	8d 83 a5 e0 ff ff    	lea    -0x1f5b(%ebx),%eax
40000c48:	50                   	push   %eax
40000c49:	e8 a4 f5 ff ff       	call   400001f2 <printf>
40000c4e:	83 c4 10             	add    $0x10,%esp
40000c51:	eb b5                	jmp    40000c08 <main+0xa7>
40000c53:	66 90                	xchg   %ax,%ax
40000c55:	66 90                	xchg   %ax,%ax
...
40000c61:	57                   	push   %edi
40000c62:	56                   	push   %esi
40000c63:	53                   	push   %ebx
40000c64:	83 ec 1c             	sub    $0x1c,%esp
40000c67:	8b 54 24 3c          	mov    0x3c(%esp),%edx
40000c6b:	8b 6c 24 30          	mov    0x30(%esp),%ebp
40000c6f:	8b 74 24 34          	mov    0x34(%esp),%esi
40000c73:	8b 5c 24 38          	mov    0x38(%esp),%ebx
40000c77:	85 d2                	test   %edx,%edx
40000c79:	75 35                	jne    40000cb0 <__udivdi3+0x50>
40000c7b:	39 f3                	cmp    %esi,%ebx
40000c7d:	0f 87 bd 00 00 00    	ja     40000d40 <__udivdi3+0xe0>
40000c83:	85 db                	test   %ebx,%ebx
40000c85:	89 d9                	mov    %ebx,%ecx
40000c87:	75 0b                	jne    40000c94 <__udivdi3+0x34>
40000c89:	b8 01 00 00 00       	mov    $0x1,%eax
40000c8e:	31 d2                	xor    %edx,%edx
40000c90:	f7 f3                	div    %ebx
40000c92:	89 c1                	mov    %eax,%ecx
40000c94:	31 d2                	xor    %edx,%edx
40000c96:	89 f0                	mov    %esi,%eax
40000c98:	f7 f1                	div    %ecx
40000c9a:	89 c6                	mov    %eax,%esi
40000c9c:	89 e8                	mov    %ebp,%eax
40000c9e:	89 f7                	mov    %esi,%edi
40000ca0:	f7 f1                	div    %ecx
40000ca2:	89 fa                	mov    %edi,%edx
40000ca4:	83 c4 1c             	add    $0x1c,%esp
40000ca7:	5b                   	pop    %ebx
40000ca8:	5e                   	pop    %esi
40000ca9:	5f                   	pop    %edi
40000caa:	5d                   	pop    %ebp
...
40000cb0:	39 f2                	cmp    %esi,%edx
40000cb2:	77 7c                	ja     40000d30 <__udivdi3+0xd0>
40000cb4:	0f bd fa             	bsr    %edx,%edi
40000cb7:	83 f7 1f             	xor    $0x1f,%edi
40000cba:	0f 84 98 00 00 00    	je     40000d58 <__udivdi3+0xf8>
40000cc0:	89 f9                	mov    %edi,%ecx
40000cc2:	b8 20 00 00 00       	mov    $0x20,%eax
40000cc7:	29 f8                	sub    %edi,%eax
40000cc9:	d3 e2                	shl    %cl,%edx
40000ccb:	89 54 24 08          	mov    %edx,0x8(%esp)
40000ccf:	89 c1                	mov    %eax,%ecx
40000cd1:	89 da                	mov    %ebx,%edx
40000cd3:	d3 ea                	shr    %cl,%edx
40000cd5:	8b 4c 24 08          	mov    0x8(%esp),%ecx
40000cd9:	09 d1                	or     %edx,%ecx
40000cdb:	89 f2                	mov    %esi,%edx
40000cdd:	89 4c 24 08          	mov    %ecx,0x8(%esp)
40000ce1:	89 f9                	mov    %edi,%ecx
40000ce3:	d3 e3                	shl    %cl,%ebx
40000ce5:	89 c1                	mov    %eax,%ecx
40000ce7:	d3 ea                	shr    %cl,%edx
40000ce9:	89 f9                	mov    %edi,%ecx
40000ceb:	89 5c 24 0c          	mov    %ebx,0xc(%esp)
40000cef:	d3 e6                	shl    %cl,%esi
40000cf1:	89 eb                	mov    %ebp,%ebx
40000cf3:	89 c1                	mov    %eax,%ecx
40000cf5:	d3 eb                	shr    %cl,%ebx
40000cf7:	09 de                	or     %ebx,%esi
40000cf9:	89 f0                	mov    %esi,%eax
40000cfb:	f7 74 24 08          	divl   0x8(%esp)
40000cff:	89 d6                	mov    %edx,%esi
40000d01:	89 c3                	mov    %eax,%ebx
40000d03:	f7 64 24 0c          	mull   0xc(%esp)
40000d07:	39 d6                	cmp    %edx,%esi
40000d09:	72 0c                	jb     40000d17 <__udivdi3+0xb7>
40000d0b:	89 f9                	mov    %edi,%ecx
40000d0d:	d3 e5                	shl    %cl,%ebp
40000d0f:	39 c5                	cmp    %eax,%ebp
40000d11:	73 5d                	jae    40000d70 <__udivdi3+0x110>
40000d13:	39 d6                	cmp    %edx,%esi
40000d15:	75 59                	jne    40000d70 <__udivdi3+0x110>
40000d17:	8d 43 ff             	lea    -0x1(%ebx),%eax
40000d1a:	31 ff                	xor    %edi,%edi
40000d1c:	89 fa                	mov    %edi,%edx
40000d1e:	83 c4 1c             	add    $0x1c,%esp
40000d21:	5b                   	pop    %ebx
40000d22:	5e                   	pop    %esi
40000d23:	5f                   	pop    %edi
40000d24:	5d                   	pop    %ebp
...
40000d30:	31 ff                	xor    %edi,%edi
40000d32:	31 c0                	xor    %eax,%eax
40000d34:	89 fa                	mov    %edi,%edx
40000d36:	83 c4 1c             	add    $0x1c,%esp
40000d39:	5b                   	pop    %ebx
40000d3a:	5e                   	pop    %esi
40000d3b:	5f                   	pop    %edi
40000d3c:	5d                   	pop    %ebp
...
40000d40:	31 ff                	xor    %edi,%edi
40000d42:	89 e8                	mov    %ebp,%eax
40000d44:	89 f2                	mov    %esi,%edx
40000d46:	f7 f3                	div    %ebx
40000d48:	89 fa                	mov    %edi,%edx
40000d4a:	83 c4 1c             	add    $0x1c,%esp
40000d4d:	5b                   	pop    %ebx
40000d4e:	5e                   	pop    %esi
40000d4f:	5f                   	pop    %edi
40000d50:	5d                   	pop    %ebp
...
40000d58:	39 f2                	cmp    %esi,%edx
40000d5a:	72 06                	jb     40000d62 <__udivdi3+0x102>
40000d5c:	31 c0                	xor    %eax,%eax
40000d5e:	39 eb                	cmp    %ebp,%ebx
40000d60:	77 d2                	ja     40000d34 <__udivdi3+0xd4>
40000d62:	b8 01 00 00 00       	mov    $0x1,%eax
40000d67:	eb cb                	jmp    40000d34 <__udivdi3+0xd4>
40000d69:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
40000d70:	89 d8                	mov    %ebx,%eax
40000d72:	31 ff                	xor    %edi,%edi
40000d74:	eb be                	jmp    40000d34 <__udivdi3+0xd4>
...
40000d84:	83 ec 1c             	sub    $0x1c,%esp
40000d87:	8b 6c 24 3c          	mov    0x3c(%esp),%ebp
40000d8b:	8b 74 24 30          	mov    0x30(%esp),%esi
40000d8f:	8b 5c 24 34          	mov    0x34(%esp),%ebx
40000d93:	8b 7c 24 38          	mov    0x38(%esp),%edi
40000d97:	85 ed                	test   %ebp,%ebp
40000d99:	89 f0                	mov    %esi,%eax
40000d9b:	89 da                	mov    %ebx,%edx
40000d9d:	75 19                	jne    40000db8 <__umoddi3+0x38>
40000d9f:	39 df                	cmp    %ebx,%edi
40000da1:	0f 86 b1 00 00 00    	jbe    40000e58 <__umoddi3+0xd8>
40000da7:	f7 f7                	div    %edi
...
40000db8:	39 dd                	cmp    %ebx,%ebp
40000dba:	77 f1                	ja     40000dad <__umoddi3+0x2d>
40000dbc:	0f bd cd             	bsr    %ebp,%ecx
40000dbf:	83 f1 1f             	xor    $0x1f,%ecx
40000dc2:	89 4c 24 04          	mov    %ecx,0x4(%esp)
40000dc6:	0f 84 b4 00 00 00    	je     40000e80 <__umoddi3+0x100>
40000dcc:	b8 20 00 00 00       	mov    $0x20,%eax
40000dd1:	89 c2                	mov    %eax,%edx
40000dd3:	8b 44 24 04          	mov    0x4(%esp),%eax
40000dd7:	29 c2                	sub    %eax,%edx
40000dd9:	89 c1                	mov    %eax,%ecx
40000ddb:	89 f8                	mov    %edi,%eax
40000ddd:	d3 e5                	shl    %cl,%ebp
40000ddf:	89 d1                	mov    %edx,%ecx
40000de1:	89 54 24 0c          	mov    %edx,0xc(%esp)
40000de5:	d3 e8                	shr    %cl,%eax
40000de7:	09 c5                	or     %eax,%ebp
40000de9:	8b 44 24 04          	mov    0x4(%esp),%eax
40000ded:	89 c1                	mov    %eax,%ecx
40000def:	d3 e7                	shl    %cl,%edi
40000df1:	89 d1                	mov    %edx,%ecx
40000df3:	89 7c 24 08          	mov    %edi,0x8(%esp)
40000df7:	89 df                	mov    %ebx,%edi
40000df9:	d3 ef                	shr    %cl,%edi
40000dfb:	89 c1                	mov    %eax,%ecx
40000dfd:	89 f0                	mov    %esi,%eax
40000dff:	d3 e3                	shl    %cl,%ebx
40000e01:	89 d1                	mov    %edx,%ecx
40000e03:	89 fa                	mov    %edi,%edx
40000e05:	d3 e8                	shr    %cl,%eax
40000e07:	0f b6 4c 24 04       	movzbl 0x4(%esp),%ecx
40000e0c:	09 d8                	or     %ebx,%eax
40000e0e:	f7 f5                	div    %ebp
40000e10:	d3 e6                	shl    %cl,%esi
40000e12:	89 d1                	mov    %edx,%ecx
40000e14:	f7 64 24 08          	mull   0x8(%esp)
40000e18:	39 d1                	cmp    %edx,%ecx
40000e1a:	89 c3                	mov    %eax,%ebx
40000e1c:	89 d7                	mov    %edx,%edi
40000e1e:	72 06                	jb     40000e26 <__umoddi3+0xa6>
40000e20:	75 0e                	jne    40000e30 <__umoddi3+0xb0>
40000e22:	39 c6                	cmp    %eax,%esi
40000e24:	73 0a                	jae    40000e30 <__umoddi3+0xb0>
40000e26:	2b 44 24 08          	sub    0x8(%esp),%eax
40000e2a:	19 ea                	sbb    %ebp,%edx
40000e2c:	89 d7                	mov    %edx,%edi
40000e2e:	89 c3                	mov    %eax,%ebx
40000e30:	89 ca                	mov    %ecx,%edx
40000e32:	0f b6 4c 24 0c       	movzbl 0xc(%esp),%ecx
40000e37:	29 de                	sub    %ebx,%esi
40000e39:	19 fa                	sbb    %edi,%edx
40000e3b:	8b 5c 24 04          	mov    0x4(%esp),%ebx
40000e3f:	89 d0                	mov    %edx,%eax
40000e41:	d3 e0                	shl    %cl,%eax
40000e43:	89 d9                	mov    %ebx,%ecx
40000e45:	d3 ee                	shr    %cl,%esi
40000e47:	d3 ea                	shr    %cl,%edx
40000e49:	09 f0                	or     %esi,%eax
40000e4b:	83 c4 1c             	add    $0x1c,%esp
40000e4e:	5b                   	pop    %ebx
40000e4f:	5e                   	pop    %esi
40000e50:	5f                   	pop    %edi
40000e51:	5d                   	pop    %ebp
...
40000e58:	85 ff                	test   %edi,%edi
40000e5a:	89 f9                	mov    %edi,%ecx
40000e5c:	75 0b                	jne    40000e69 <__umoddi3+0xe9>
40000e5e:	b8 01 00 00 00       	mov    $0x1,%eax
40000e63:	31 d2                	xor    %edx,%edx
40000e65:	f7 f7                	div    %edi
40000e67:	89 c1                	mov    %eax,%ecx
40000e69:	89 d8                	mov    %ebx,%eax
40000e6b:	31 d2                	xor    %edx,%edx
40000e6d:	f7 f1                	div    %ecx
40000e6f:	89 f0                	mov    %esi,%eax
40000e71:	f7 f1                	div    %ecx
40000e73:	e9 31 ff ff ff       	jmp    40000da9 <__umoddi3+0x29>
40000e78:	90                   	nop
40000e79:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
40000e80:	39 dd                	cmp    %ebx,%ebp
40000e82:	72 08                	jb     40000e8c <__umoddi3+0x10c>
40000e84:	39 f7                	cmp    %esi,%edi
40000e86:	0f 87 21 ff ff ff    	ja     40000dad <__umoddi3+0x2d>
40000e8c:	89 da                	mov    %ebx,%edx
40000e8e:	89 f0                	mov    %esi,%eax
40000e90:	29 f8                	sub    %edi,%eax
40000e92:	19 ea                	sbb    %ebp,%edx
40000e94:	e9 14 ff ff ff       	jmp    40000dad <__umoddi3+0x2d>
