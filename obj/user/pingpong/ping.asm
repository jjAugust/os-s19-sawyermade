...
40000bac:	6a 64                	push   $0x64
40000bae:	8d 83 04 e0 ff ff    	lea    -0x1ffc(%ebx),%eax
40000bb4:	50                   	push   %eax
40000bb5:	e8 38 f6 ff ff       	call   400001f2 <printf>
    *addr = val;
40000bba:	c7 05 00 00 00 e0 64 	movl   $0x64,0xe0000000
40000bc1:	00 00 00 
    yield();
40000bc4:	e8 06 fc ff ff       	call   400007cf <yield>
    printf("ping: the new value at address %x: %d\n", addr, *addr);
40000bc9:	83 c4 0c             	add    $0xc,%esp
40000bcc:	ff 35 00 00 00 e0    	pushl  0xe0000000
40000bd2:	68 00 00 00 e0       	push   $0xe0000000
40000bd7:	8d 83 34 e0 ff ff    	lea    -0x1fcc(%ebx),%eax
40000bdd:	50                   	push   %eax
40000bde:	e8 0f f6 ff ff       	call   400001f2 <printf>
40000be3:	83 c4 10             	add    $0x10,%esp

    return 0;
}
40000be6:	b8 00 00 00 00       	mov    $0x0,%eax
40000beb:	8d 65 f8             	lea    -0x8(%ebp),%esp
40000bee:	59                   	pop    %ecx
40000bef:	5b                   	pop    %ebx
40000bf0:	5d                   	pop    %ebp
40000bf1:	8d 61 fc             	lea    -0x4(%ecx),%esp
40000bf4:	c3                   	ret    
40000bf5:	66 90                	xchg   %ax,%ax
40000bf7:	66 90                	xchg   %ax,%ax
40000bf9:	66 90                	xchg   %ax,%ax
40000bfb:	66 90                	xchg   %ax,%ax
40000bfd:	66 90                	xchg   %ax,%ax
40000bff:	90                   	nop
